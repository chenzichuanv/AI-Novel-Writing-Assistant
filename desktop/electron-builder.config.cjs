...
const githubOwner = firstNonEmpty(process.env.AI_NOVEL_GITHUB_OWNER, "winnerineast");
const githubRepo = firstNonEmpty(process.env.AI_NOVEL_GITHUB_REPO, "GeneralAgent");

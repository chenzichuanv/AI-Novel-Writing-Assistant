...
export const CaptionLayer: React.FC<{captions: Caption[]; color: string}> = ({captions, color}) => {
  ...
  const translateY = interpolate(localFrame, [0, 7], [10, 0], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });

  return (
    <div className="caption-safe-area">
      <div
        className={`caption-text caption-${active.kind}`}
        style={{
          color,
          opacity,

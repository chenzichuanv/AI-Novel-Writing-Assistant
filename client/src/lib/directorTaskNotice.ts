...
export function isChapterTitleDiversitySummary(value: string | null | undefined): boolean {
  ...
  return normalized.includes(i18next.t("dict.gen_083944a1"))
    || normalized.includes(i18next.t("dict.gen_9377d021"))
    || normalized.includes(i18next.t("dict.gen_85fb944c"));
}

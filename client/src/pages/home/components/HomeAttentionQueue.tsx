...
export function HomeAttentionQueue(props: { items: HomeAttentionItem[]; hasNovels: boolean }) {
  ...
  return (
    <Card className="home-attention-queue border-0 bg-[#eef5f8] shadow-none">
      <CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-base tracking-normal"><ListChecks className="h-4 w-4 text-sky-700" aria-hidden="true" />{i18next.t("home.homeAttentionQueue.aoxdsz")}</CardTitle></CardHeader>
